...
.. image:: http://img.shields.io/badge/docs-v3.2.1-yellow.svg
   :target: https://www.idiap.ch/software/bob/docs/bob/bob.bio.spear/v3.2.1/index.html
.. image:: http://img.shields.io/badge/docs-latest-orange.svg
   :target: https://www.idiap.ch/software/bob/docs/bob/bob.bio.spear/master/index.html
.. image:: https://gitlab.idiap.ch/bob/bob.bio.spear/badges/v3.2.1/build.svg
   :target: https://gitlab.idiap.ch/bob/bob.bio.spear/commits/v3.2.1
.. image:: https://gitlab.idiap.ch/bob/bob.bio.spear/badges/v3.2.1/coverage.svg
   :target: https://gitlab.idiap.ch/bob/bob.bio.spear/commits/v3.2.1
...
For further information about ``bob.bio``, please read `its Documentation <https://www.idiap.ch/software/bob/docs/bob/bob.bio.base/v3.2.1/index.html>`_.
